...
const ACCESS_TOKEN_KEY = "emernow_access_token";
const REFRESH_TOKEN_KEY = "emernow_refresh_token";
const EXPIRES_AT_KEY = "emernow_token_expires_at";
        ...
        <aside className="sidebar-surface flex min-h-screen flex-col px-3 py-3">
          ...
          <div className="flex items-center gap-2.5 px-2.5 py-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted">Emernow</p>
            </div>
          </div>
